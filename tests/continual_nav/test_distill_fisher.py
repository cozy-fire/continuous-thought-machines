...
class DistillFisherTests(unittest.TestCase):
    ...
    def test_streaming_teacher_isolation_history_tail_and_student_update(self):
        ...
        self.assertFalse(first.valid_mask[:20].any())
        ...
        torch.testing.assert_close(second.obs[10:20], first.obs[20:])
        self.assertFalse(second.valid_mask[:10].any())
        self.assertTrue(second.valid_mask[10:21].all())
        self.assertFalse(second.valid_mask[21:].any())
